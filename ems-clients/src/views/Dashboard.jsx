        ...
        <div className="container-fluid py-4">
            <div className="row">
                <div className="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <Card title='Employees' number={46} iconBg={'primary'} />
                </div>
                <div className="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <Card title='Permanent Staff' number={33} iconBg={'danger'} />
                </div>
                <div className="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <Card title='Contract Staff' number={12} iconBg={'success'} />
                </div>
                <div className="col-xl-3 col-sm-6">
                    <Card title='Team Leaders' number={25} iconBg={'success'} />
                </div>
            </div>
